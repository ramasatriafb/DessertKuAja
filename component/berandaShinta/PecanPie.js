...
import NutrisiPecan from './pecanPie/NutrisiPecan'
import BahanPecan from './pecanPie/BahanPecan'
import TataCaraPecan from './pecanPie/TataCaraPecan'

import Images from 'asset/Images';
import { Grid, Row } from "react-native-easy-grid";
export default class PecanPie extends Component {
  ...
  render() {
    return (
      ...
      width: 125, }} source={Images.headerIcon}/>
        ...
        width: null,
        height: null,
        resizeMode: 'cover' }} source={Images.pecanPie} />
        </Row>
