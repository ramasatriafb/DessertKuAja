...
import NutrisiCinnamon from './cinnamonIce/NutrisiCinnamon'
import BahanCinnamon from './cinnamonIce/BahanCinnamon'
import TataCaraCinnamon from './cinnamonIce/TataCaraCinnamon'

import Images from 'asset/Images';
import { Grid, Row } from "react-native-easy-grid";
export default class CinnamonIce extends Component {
  ...
  render() {
    return (
      ...
      width: 125, }} source={Images.headerIcon}/>
        ...
        width: null,
        height: null,
        resizeMode: 'cover' }} source={Images.cinnamonIce} />
        </Row>
        ...
        marginBottom:10,
        marginTop:10,
        paddingLeft: 20}} >Cinnamon Ice Cream</Text>
        </Row>
        <Row size={55}> 
